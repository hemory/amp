...
This is what makes Amp's semantic search better than generic indexing. Instead of dumping everything into one blob, we analyze the vault and create purpose-built collections.
