...
**This is what Amp does** - turns your calendar chaos into structure automatically.
...
**This is what Amp does - it works while you're not looking.**
...
• [Capability 1] - [Amp use case]
• [Capability 2] - [Amp use case]
• [Capability 3] - [Amp use case]
...
**Step 5: Offer More**
```
"Want to connect another tool? Or explore what else Amp can do?"
...
**What we'll set up:**
• Calendar sync (see meetings in Amp)
...
Search the vault for references to tools the user hasn't connected yet (Slack, Todoist, Google Calendar, Zoom, etc.). Check file contents in `00-Inbox/`, `04-Projects/`, and `05-Areas/` for mentions.

### Presenting Recommendations

**Only surface high-value items** (keep it light, this isn't onboarding, it's a nudge).
...
**Discovery:**
• `/amp-level-up` - Find features you haven't tried
...
After full tour:
- "Remember - invoke `/amp-level-up` to discover more"
