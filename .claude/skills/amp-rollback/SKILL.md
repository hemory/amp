...
4. **Keep regular backups**
   ...
   - Or manually copy Amp folder weekly

---

## Related Commands

- `/amp-update` - Update to latest version
- `/amp-whats-new` - Check what's available
- `/setup` - Verify Amp configuration
