...
**When to run:**
- After initial Amp installation
...
- **Privacy:** All calendar data stays local - Amp never sends calendar data anywhere
- **Fallback:** If EventKit isn't available, Amp falls back to AppleScript (works but slower)
...
- This should have been installed during Amp setup
