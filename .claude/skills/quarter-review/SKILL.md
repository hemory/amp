...
Look for `00-Inbox/*Weekly*Synthesis*.md` files in quarter:
...
Review the Amp system itself and improvement backlog.

### Check Amp Backlog

Read `System/Amp_Backlog.md` if it exists:
...
> "💡 Consider running `/amp-backlog` soon to re-rank ideas based on updated system state."

**If no Amp_Backlog.md exists:**
- Skip this section silently
- In review document, note: "Amp backlog system not yet in use"
...
### System Improvements
- [Amp system improvements identified]

---

## System Health & Improvement Backlog

### Amp Backlog Activity
...
*Run `/amp-backlog` for full ranked list*
