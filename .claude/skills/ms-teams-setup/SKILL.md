---
name: ms-teams-setup
description: Connect Microsoft Teams to Amp for cross-channel context awareness
integration:
  id: teams
...
Connect your Microsoft Teams workspace to Amp so your daily plans, meeting prep, and people pages get richer context from Teams conversations.
...
- Amp reads Teams messages **on demand** -- nothing is stored permanently
...
```
**Let's connect Microsoft Teams to Amp.**
...
```
I need to add the Teams connector to your Amp configuration.

This adds a bridge that lets Amp read your Teams messages and channels
...
You'll need to authorize Amp to read your Teams data. This opens a browser
