...
Initialize your Career Development system in Amp. Captures your job description, career ladder, latest review, and long-term growth goals to create a foundation for ongoing career coaching.
...
I'm going to help you set up a Career Development system in Amp. This will become your personal career coach — tracking your growth, capturing evidence of your work, and helping you prepare for reviews and promotions.
...
As you work, Amp automatically captures evidence that supports your career progression:
...
**This system is most powerful when it captures evidence passively as you work. Don't worry about manual updates — Amp handles it.**
```
...
1. **Career folder exists** → Amp knows to capture career evidence during daily work
...
- **First time using Amp** → Part of onboarding
