...
Check for `00-Inbox/[last-monday] - Weekly Synthesis.md` (also check legacy `00-Inbox/Weekly_Synthesis_[last-monday].md`):
...
Check `System/Amp_Backlog.md` for high-priority improvement ideas worth tackling this week.
...
| Granola | granola-mcp | `get_upcoming_meetings` (optional) |
