...
4. **Update file** - Write new rankings to `System/Amp_Backlog.md`
...
2. Pass to `/amp-improve` with context:
   ...
   ```
3. `/amp-improve` takes over for workshopping
