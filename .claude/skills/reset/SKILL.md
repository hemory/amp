---
name: reset
description: Restructure Amp system based on new role or preferences
disable-model-invocation: true
---

## Purpose

Re-run the onboarding flow to restructure your Amp system. Useful when:
- Your role changes (promotion, new job, pivot)
- You want to reorganize after using Amp for a while
...
Say: "Let's reset your Amp setup. I'll walk you through the same questions as initial setup, then reorganize your structure. **Your existing content will be preserved** - I'll move files to match the new structure, not delete them."
