...
**In plain English:** A guided wizard that helps you create and integrate an MCP server into Amp. No coding knowledge required - you describe what you want, we build it together.

**When to use it:**
- You want to connect Amp to an external service (calendar, email, CRM, API)
- You have data somewhere that would be useful in Amp
...
MCP (Model Context Protocol) lets Amp connect to external tools and services. Instead of guessing or saying "I don't have access", AI can query real data and give you accurate answers.
...
4. Integrate it into Amp
5. Update all documentation so future sessions know how to use it

Ready to get started? **What would you like to connect Amp to?**
...
```
What specific information do you want Amp to access?
...
### Goal: Connect the MCP server to Amp
...
Add to `06-Resources/Amp_System/Amp_System_Guide.md` under Integration Options:
