---
name: amp-obsidian-setup
description: Enable Obsidian integration and migrate existing vault to wiki links
---

## Purpose

Convert Amp vault to Obsidian wiki link format for graph-based navigation.
...
Say: "This will enable **Obsidian mode** in your Amp vault:
...
**If NO:** Say "No problem! You can run `/amp-obsidian-setup` anytime." and exit.
...
Ask: "Want me to generate an Obsidian configuration optimized for Amp? This includes:
...
Ask: "Want to enable bidirectional sync? This keeps task checkboxes synced between Obsidian and Amp:
...
**Next steps:**
1. Open Obsidian: File → Open Folder → select your Amp vault folder
...
**Resources:**
- See `06-Resources/Amp_System/Obsidian_Guide.md` for detailed tips
- Watch the [beginner's guide](https://www.youtube.com/watch?v=gafuqdKwD_U) if you're new to Obsidian

You can still use Amp in Cursor/terminal exactly as before. Wiki links work everywhere."
