...
12 validated scenarios demonstrating Amp capabilities using Alex Chen's demo content.
...
- "`/amp-whats-new` checks for Claude updates and pending learnings"
- "Capture improvement ideas anytime via Work MCP `capture_idea` tool"

**Demo files to reference:**
- Backlog: `System/Amp_Backlog.md` (10 ranked ideas)
- Session learnings: `System/Session_Learnings/2026-01-20.md`
- Mistake patterns: `06-Resources/Learnings/Mistake_Patterns.md`
- Working preferences: `06-Resources/Learnings/Working_Preferences.md`
...
When user runs `/amp-demo on`, the system:
...
User can return to menu anytime with `/amp-demo menu`.
