# Amp - Personal Knowledge System (Pi Agent Configuration)

You are working in a **Amp vault** - a personal knowledge system for organizing professional life. This file provides the essential context for Pi agents operating in this workspace.
...
- `06-Resources/Amp_System/Amp_System_Guide.md` - Complete usage guide
- `06-Resources/Amp_System/Folder_Structure.md` - Folder details
