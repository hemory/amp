#!/usr/bin/env node
/**
 * SessionStart hook: Sync Pi-built extensions into Amp's skill system
 *
...
/**
 * Generate an Amp skill stub for a Pi extension
 */
...
> It provides access to Pi tools within the Amp environment.

${extension.description || 'No description available.'}

${toolsSection}${commandsSection}## How to Use

This extension was built in Pi and synced to Amp. The tools are available to Pi but
provide context for Amp about what capabilities exist in the Pi environment.
