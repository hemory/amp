...
**Purpose:** Technical documentation for developers and advanced users working on Amp internals.

**⚠️ For Technical Users** - This folder contains architecture docs, implementation details, and integration guides. If you're just using Amp, you don't need to read these files.

---

## What Is Reference Documentation?

**Reference docs** are technical guides that explain *how* and *why* Amp works under the hood. These are for:
- Claude when implementing new features
- Developers extending Amp
...
**Example scenario:**
- User: "Add Slack integration to Amp"
