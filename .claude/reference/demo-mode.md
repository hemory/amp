...
Amp includes a demo mode with pre-populated content so you can explore the system before adding your own data.

## Toggling Demo Mode

- `/amp-demo on` - Enable demo mode and launch interactive demo selector
- `/amp-demo off` - Disable demo mode (use your real vault)
- `/amp-demo menu` - Show demo scenario menu (when demo mode is on)
- `/amp-demo status` - Check current mode
- `/amp-demo reset` - Restore demo content to original state

## Interactive Demo Selector

When you run `/amp-demo on`, you'll see a menu of **12 validated demo scenarios** that showcase different aspects of Amp.
...
5. Return to menu anytime with `/amp-demo menu`
...
- Amp_Backlog.md with 10 ranked improvement ideas (AI-scored)
- usage_log.md tracking feature adoption
- Ideas folder with unprocessed thoughts for `/triage`

## When to Use Demo Mode

- **New users:** Explore how Amp works before adding your own content
