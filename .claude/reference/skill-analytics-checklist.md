# Amp Skill Development - Analytics Checklist

**When creating or modifying any Amp skill, MCP tool, or capability, complete this checklist.**
...
- PII
- User customizations or additions (only Amp built-in features)

---

## 2. Update Event Strategy

Add your event to `System/PRDs/amp-analytics-events.md`:
...
- `/amp-level-up` feature discovery
...
- [ ] **Amp-only** - Only tracking built-in Amp features (not user customizations)
...
**Files to update:**
1. `System/PRDs/amp-analytics-events.md` - Event definition
...
**2. amp-analytics-events.md entry:**
```markdown
...
*This checklist ensures Amp can track feature adoption while respecting user privacy.*
