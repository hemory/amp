...
/**
 * Amp Meeting Intel — Granola MCP OAuth 2.0 Authentication
 *
...
const CLIENT_NAME = 'Amp Meeting Intel';

const TOKEN_DIR = path.join(os.homedir(), '.config', 'amp');
...
<html>
<head><title>Amp - Authorization Complete</title>
<style>
