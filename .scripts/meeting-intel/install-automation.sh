...
# Amp Meeting Intel - Background Automation Installer
#
...
PLIST_NAME="com.amp.meeting-intel"
...
echo ""
echo "╔════════════════════════════════════════════╗"
echo "║   Amp Meeting Intel - Background Sync      ║"
echo "╚════════════════════════════════════════════╝"
echo ""
...
GRANOLA_TOKENS="$HOME/.config/amp/granola-tokens.json"
